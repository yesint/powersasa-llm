/* 
This is heavily refactored version of the PowerSASA software
initially taken from https://github.com/multiscale-modelling/pdsasa.
Refactoring is done with Codex.
*/
...

{
	...
	for (j = 1; j < n; ++j)
	{
		...
		{
			std::println("PowerSasa: Precision insufficient to resolve angles");
			throw PowerSasaException();
		}
	}
...
// Code structure:
//   1) Gather neighbours and angular geometry.
